...
export default function RagOverCountrySecurityBriefingsAndHistoricalPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/cf-rag-over-country-security-briefings-and-historical/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>RAG over country security briefings and historical incident data</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-rag-over-country-security-briefings-and-historical/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
