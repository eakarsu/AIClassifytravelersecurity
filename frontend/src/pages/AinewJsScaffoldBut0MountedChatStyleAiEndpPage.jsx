...
export default function AinewJsScaffoldBut0MountedChatStyleAiEndpPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/gap-ainew-js-scaffold-but-0-mounted-chat-style-ai-endp/run', {
        method: 'POST',
